...
export class PythonManagementCreateForm extends React.Component<PythonManagementCreateFormProps> {
  ...
  render() {
    const waldurPublicKeyHelp = (
      <>
        Ensure that Waldur public key is present in authorized_keys file on the selected instance
        <br/>
        <a onClick={this.unwrapOrCollapsePublicKeyHelp}>Help</a>
        {this.state.publicKeyHelpCollaped ? null :
          <>
            <br/>
            Ensure that Waldur public key is present in /home/SYSTEM_DEFAULT_USER/.ssh/authorized_keys file.
            <br/>
                  ...
                  <form
                    ...
                    <FormContainer
                      ...
                      <CheckboxField
                        ...
                        label={this.props.translate('Virtual machine has Waldur public key')}
