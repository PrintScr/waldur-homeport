...
export const TYPE_READABLE_TEXT_MAPPING: PythonManagementRequestTypeReadabilityMap = Object.freeze({
  [PythonManagementRequestType.OVERALL]: translate('Overall state'),
  [PythonManagementRequestType.SYNCHRONIZATION]: translate('Virtual environment synchronization'),
  [PythonManagementRequestType.INITIALIZATION]: translate('Virtual environment initialization'),
  [PythonManagementRequestType.VIRTUAL_ENVS_SEARCH]: translate('Virtual environments search'),
  [PythonManagementRequestType.INSTALLED_LIBRARIES_SEARCH]: translate('Installed libraries search'),
  [PythonManagementRequestType.PYTHON_MANAGEMENT_DELETION]: translate('Python management environment deletion'),
  [PythonManagementRequestType.VIRTUAL_ENVIRONMENT_DELETION]: translate('Virtual environment deletion'),
});
